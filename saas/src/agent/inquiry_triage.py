...
EMERGENCY_RULES: tuple[EmergencyRule, ...] = (
    ...
    # 東京ガスネットワーク「ガス臭いときは」（2026-09-17確認）:
    # https://www.tokyo-gas.co.jp/network/emergencies/kusai/index.html
    EmergencyRule(
        kind="gas",
        label="ガス",
        keywords=("ガス臭", "ガスくさい", "ガスが臭", "ガスがくさい", "ガスの臭い", "ガスのにおい", "ガス漏れ"),
        guidance=(
            "ガスの臭いがする場合は、火を使わず、電気のスイッチや換気扇に触れないでください。"
            "室内で臭う場合は、窓や戸を手で開けて換気してください。"
            "屋外で臭う場合は、窓や戸を閉めてガスが室内へ入らないようにしてください。"
            "安全に操作できる場合はガス栓・メーターガス栓を閉め、"
            "安全な場所から地域のガス漏れ緊急窓口へ連絡してください。"
        ),
    ),
    EmergencyRule(
        kind="electric",
